...
class FacilitiesState with _$FacilitiesState {
  ...
  const factory FacilitiesState.loaded(LocationModel location) = FacilitiesLoaded;
  const factory FacilitiesState.error(Failure<LocationErrorsEnum> failure) = FacilitiesError;
}

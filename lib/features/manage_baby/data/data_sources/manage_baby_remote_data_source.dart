...
abstract class ManageBabyRemoteDataSource {
...
@LazySingleton(as: ManageBabyRemoteDataSource)
class ManageBabyRemoteDataSourceImpl implements ManageBabyRemoteDataSource {
  ManageBabyRemoteDataSourceImpl(this._firebaseManager);

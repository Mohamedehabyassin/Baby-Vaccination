...
part of 'manage_baby_event.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ManageBabyEvent);
}
...
/// @nodoc
class $ManageBabyEventCopyWith<$Res>  {
$ManageBabyEventCopyWith(ManageBabyEvent _, $Res Function(ManageBabyEvent) __);
}


/// Adds pattern-matching-related methods to [ManageBabyEvent].
extension ManageBabyEventPatterns on ManageBabyEvent {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _ManageBaby value)?  addBaby,TResult Function( _UpdateBaby value)?  updateBaby,TResult Function( _UpdateDate value)?  updateDate,TResult Function( _UpdateGender value)?  updateGender,TResult Function( _UpdateBloodType value)?  updateBloodType,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _ManageBaby value)  addBaby,required TResult Function( _UpdateBaby value)  updateBaby,required TResult Function( _UpdateDate value)  updateDate,required TResult Function( _UpdateGender value)  updateGender,required TResult Function( _UpdateBloodType value)  updateBloodType,}){
final _that = this;
switch (_that) {
case _ManageBaby():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _ManageBaby value)?  addBaby,TResult? Function( _UpdateBaby value)?  updateBaby,TResult? Function( _UpdateDate value)?  updateDate,TResult? Function( _UpdateGender value)?  updateGender,TResult? Function( _UpdateBloodType value)?  updateBloodType,}){
final _that = this;
switch (_that) {
case _ManageBaby() when addBaby != null:
return addBaby(_that);case _UpdateBaby() when updateBaby != null:
...
class _ManageBaby implements ManageBabyEvent {
  const _ManageBaby();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ManageBaby);
}
...
@override
String toString() {
  return 'ManageBabyEvent.addBaby()';
}
...
class _UpdateBaby implements ManageBabyEvent {
  const _UpdateBaby();
...
@override
String toString() {
  return 'ManageBabyEvent.updateBaby()';
}
...
class _UpdateDate implements ManageBabyEvent {
...
@override
String toString() {
  return 'ManageBabyEvent.updateDate(date: $date)';
}
...
/// @nodoc
abstract mixin class _$UpdateDateCopyWith<$Res> implements $ManageBabyEventCopyWith<$Res> {
...
class _UpdateGender implements ManageBabyEvent {
...
@override
String toString() {
  return 'ManageBabyEvent.updateGender(gender: $gender)';
}
...
/// @nodoc
abstract mixin class _$UpdateGenderCopyWith<$Res> implements $ManageBabyEventCopyWith<$Res> {
...
class _UpdateBloodType implements ManageBabyEvent {
...
@override
String toString() {
  return 'ManageBabyEvent.updateBloodType(bloodType: $bloodType)';
}
...
/// @nodoc
abstract mixin class _$UpdateBloodTypeCopyWith<$Res> implements $ManageBabyEventCopyWith<$Res> {
